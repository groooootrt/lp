...
$(document).ready(function () {
    ...
    */
    function fetchData() {
        var html;
        fetch('https://cdn2.hubspot.net/hubfs/486579/LegalParse/NL/v2/NL_Privacy_policy.html?thr')
    ...
    function innerHeaders() {
        ...
        $.each(headings, function () {
            if (headings[x].length > 1) {
                h_aux = '<div class="row"><div class="span12 sm_section"><span class="h2_title"><a href="#title_h1_' + x + '" class="h2_title">' + headings[x][0] + '</a><img src="https://cdn2.hubspot.net/hubfs/486579/LegalParse/i/arrow_down.svg" alt="" class="nav_arrow_h2 collapsed"></span>';
            } else {
            ...
            if (headings[x].length > 1) {
                ...
                for (i = 1; i < headings[x].length; i++) {
                    ...
                    if (hasChild) {
                        h_aux = h_aux + '<li><span class="h3_title"><a href="#title_h2_' + h3_id + '">' + headings[x][i] + ' </a><img src = "https://cdn2.hubspot.net/hubfs/486579/LegalParse/i/arrow_up.svg" alt="" class="nav_arrow_h3 expanded"></></span></li>';
                    } else {
    ...
    */
    ...
    function changeHTMLTag() { //Replaces H1s for H2s to avoid possible issues with many H1s
        ...
        for (var i = 0; i < els.length; i++) {
            if (x != -1) {
                els[i].outerHTML = '<h2 id="title_h1_' + x + '">' + els[i].innerHTML + '</h2>';
            }
            x++;
        }
    }
