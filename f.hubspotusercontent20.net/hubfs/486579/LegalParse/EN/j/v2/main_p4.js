...
$(document).ready(function () {
    ...
    */
    function fetchData() {
        var html;
        fetch('https://cdn2.hubspot.net/hubfs/486579/LegalParse/EN_Cookie_policy.html?cx')
    ...
    function innerHeaders() {
        ...
        $.each(headings, function () {
            if (headings[x].length > 1) {
                h_aux = '<div class="row"><div class="span12 sm_section"><span class="h2_title"><a href="#title_h2_' + x + '" class="h2_title">' + headings[x][0] + '</a><img src="https://cdn2.hubspot.net/hubfs/486579/LegalParse/i/arrow_down.svg" alt="" class="nav_arrow_h2 collapsed"></span>';
            } else {
            ...
            if (headings[x].length > 1) {
                ...
                for (i = 1; i < headings[x].length; i++) {
                    ...
                    if (hasChild) {
                        h_aux = h_aux + '<li><span class="h3_title"><a href="#title_h3_' + h3_id + '">' + headings[x][i] + ' </a><img src = "https://cdn2.hubspot.net/hubfs/486579/LegalParse/i/arrow_up.svg" alt="" class="nav_arrow_h3 expanded"></></span></li>';
                    } else {
